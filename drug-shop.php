...
<body class="text-white bg-black flex">
  ...
  <content class="p-4 h-dvh grow overflow-y-auto">
    <div class="flex justify-between">
      <h1 class="text-4xl font-bold py-4"><span class="text-[#146eb4]">Drug Store</h1>
      <div class="uk-margin">

        <div class="flex gap-4">
            <?php include "components/add-drug.php"; ?>
            <?php include "components/drug-search-box.php"; ?>
        </div>
    ...
    <div class="flex flex-wrap gap-4 mx-auto">
        <?php include "components/drug-cards.php"?>
    </div>
