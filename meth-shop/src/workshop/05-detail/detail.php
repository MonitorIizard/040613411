...
<body class="text-white bg-black flex">
  ...
  <content class="p-4 h-dvh grow overflow-y-auto">
    ...
    <div class="flex justify-between">
      <h1 class="text-4xl font-bold py-4"><span class="text-[#146eb4]">Workshop 5:</span> detail of <span class="text-[#ff9900]"><?= $_GET["username"] ?></span> </h1>
      <div class="uk-margin">
    ...
    <a href="./5.php">
      <button class="uk-button uk-button-default bg-[#ff9900] hover:bg-orange-700 my-4">Back to member list.</button>
    </a>
  </content>
</body>
