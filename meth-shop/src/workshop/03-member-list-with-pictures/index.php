...
<body class="text-white bg-black flex">
  ...
  <content class="p-4 h-dvh grow overflow-y-auto">
    ...
    <h1 class="text-4xl font-bold py-4"><span class="text-[#146eb4]">Workshop 3:</span>  Member Lists with pictures</h1>
  ...
  ?>
     ...
     <p><?=$row ["address"]?></p>
     <p><?=$row ["email"]?></p>
     <img src="../../assets/member_photo/<?=$row["username"]?>.jpg" width="100"/>
	<hr>
  <?php } ?>
    </div>
