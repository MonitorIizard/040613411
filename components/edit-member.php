...
<div id="<?=$row["username"] ?>" class="uk-flex-top" uk-modal>
  <div class="uk-modal-body uk-margin-auto-vertical uk-modal-dialog">
    ...
    <form class="border-none overflow-y-auto h-75dvh" 
          action="http://202.44.40.193/~cs6520159/meth-shop/handle/edit-member.php" enctype="multipart/form-data" 
          method="post">
      ...
      <img 
        ...
        src="http://202.44.40.193/~cs6520159/meth-shop/assets/member_photo/<?= $row["username"]?>"
