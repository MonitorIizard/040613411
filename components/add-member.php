...
<div id="add" class="uk-flex-top" uk-modal>
  ...
  <form class="border-none overflow-y-auto h-75dvh" action="http://202.44.40.193/~cs6520159/meth-shop/handle/add-member.php" enctype="multipart/form-data" method="post">
